...
public class Customer implements Serializable {
    ...
    public String toString() {
        return "com.xmpp.sample.model.Customer[ customerId=" + customerId + " ]";
    }*/

    @Override
    public String toString() {
        return "Customer{" + "customerId=" + customerId + ", name=" + name + ", city=" + city + ", state=" + state + ", phone=" + phone + ", email=" + email + '}';
    }
